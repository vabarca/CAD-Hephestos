...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -19.30
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -31.90
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -15.30
...
//#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 150, 50} // X,Y,Z Axis Extend and Retract angles
